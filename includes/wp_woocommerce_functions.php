...
add_action( 'after_setup_theme', 'actualidad_woocommerce_support' );
function actualidad_woocommerce_support() {
...
add_action('woocommerce_before_main_content', 'actualidad_woocommerce_custom_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'actualidad_woocommerce_custom_wrapper_end', 10);

function actualidad_woocommerce_custom_wrapper_start() {
...
function actualidad_woocommerce_custom_wrapper_end() {
