...
-------------------------------------------------------------- */
/*
function register_actualidad_settings() {
...
add_action('admin_menu', 'actualidad_custom_panel_control');

function actualidad_custom_panel_control() {
    add_menu_page(
        __( 'Panel de Control', 'actualidad' ),
        __( 'Panel de Control','actualidad' ),
        'manage_options',
        'actualidad-control-panel',
        'actualidad_control_panel_callback',
        'dashicons-admin-generic',
        120
    );
    add_action( 'admin_init', 'register_actualidad_settings' );
}

function actualidad_control_panel_callback() {
    ob_start();
?>
