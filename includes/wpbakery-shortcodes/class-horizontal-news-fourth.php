 ...
 *
 */
if (!class_exists('Horizontal_News_Shortcode_Fourth')) {

    class Horizontal_News_Shortcode_Fourth extends WPBakery_Custom_Main_Class
    {
        /**
         * Main constructor
         */
        public function __construct()
        {
            ...
            add_shortcode('main_horizontal_fourth_news', array($this, 'output'));

            // Map shortcode to Visual Composer
            if (function_exists('vc_lean_map')) {
                vc_lean_map('main_horizontal_fourth_news', array($this, 'map'));
            }
        }
        ...
        public static function output($atts, $content = null)
        {
            ...
            extract(vc_map_get_attributes('main_horizontal_fourth_news', $atts));
            // Define output
            $output = '';
            $args = array('post_type' => $atts['post_type'], 'posts_per_page' => 4, 'order' => 'DESC', 'orderby' => 'date', 'post__not_in' => $posted_id, 'tax_query' => array(
                    ...
                    <div class="container p-0">
                        <div class="row">
                            <?php while ($arr_posts->have_posts()) : $arr_posts->the_post(); ?>
                                ...
                                <article class="main-horizontal-news-item col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
...
<?php
        ...
        public static function map()
        {
            ...
            return array(
                'name'        => esc_html__('Sección de noticias Horizontal (4 Columnas)', 'actualidad'),
                'description' => esc_html__('Este Shortcode retorna una seccion de noticias en horizontal.', 'actualidad'),
                'base'        => 'main_horizontal_fourth_news',
                'params'      => array(
                    array(
...
new Horizontal_News_Shortcode_Fourth;
